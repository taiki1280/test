...
class Reply:
    # モードの初期化
    MODE_ARRAY = ["コマンド",  "command", "管理者モード", "オウムモード",
                  "沈黙モード", "電卓モード", "計算モード", "財布モード", "相談モード", "特定の言葉モード", "サイコロモード"]
    ...
    def mode_selected(self):
        self.reply("現在" + self.MODE + "です。", "「" + self.MODE + "終了」といわれるまで" +
                   self.MODE + "なります", "ほかのモードに切り替えたい場合は現在のモードを終了してください。")
